...
## Build the binary from FaceProfileDaemon.swift + ProfileStateMachine.swift + FacePresenceDetector.swift (standalone canonical source; keep all three in swiftc).
